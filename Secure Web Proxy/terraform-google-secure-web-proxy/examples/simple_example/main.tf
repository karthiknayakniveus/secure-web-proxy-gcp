...
module "secure_web_proxy" {
  ...
  "allow-example1-com" = {
    enabled         = true
    description     = "Allow ${var.allow_host_1} host traffic."
    priority        = 100
    session_matcher = "host() == '${var.allow_host_1}'"
    basic_profile   = "ALLOW"
  },
  "allow-url-list-1" = {
    enabled         = true
    description     = "All the URLs in URL list ${var.url_list_1}."
    priority        = 102
    session_matcher = "inUrlList(host(), 'projects/${var.project_id}/locations/${var.region}/urlLists/${var.url_list_1}')"
    basic_profile   = "ALLOW"
  },
}
